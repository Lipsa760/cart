        ...
        {products.map((product) => (
          ...
          >
            ...
            <div className="h-14 flex justify-center items-center w-28 ">
              <div className="w-full h-8  border-2 flex justify-around items-center bg-blue-900 border-black rounded-full ">
                <button className="my-3" onClick={() => addToCart(product)}>
                  +
                </button>
                <span>0</span>
                <button
